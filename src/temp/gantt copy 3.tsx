...
const OccupancyBar: FC<OccupancyBarProps> = ({
  featureId,
  occupancy,
  timelineStartDate,
  onMove,
  ...
  return (
    ...
    >
      <DndContext
        ...
        onDragEnd={onDragEnd}
      >
        <GanttFeatureItemCard id={featureId}>
  ...
  useEffect(() => {
    if (scrollRef.current) {
      ...
      const scrollPosition =
        offset * ((columnWidth * zoom) / 100) + innerOffset - scrollRef.current.clientWidth * 0.3; // Changed from 0.5 (50%) to 0.3 (30%)
